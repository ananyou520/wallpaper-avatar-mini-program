Component({
    ...
    methods: {
        ...
        _canvasDetectionPosition: function() {
            null == this.data.canvas_top && null == this.data.canvas_left ? (this.data._canvas_overflow = !1, 
            this.setData({
                canvas_top: -5e3,
                canvas_left: -5e3
        ...
        _imgMarginDetectionPosition: function(t) {
            if (this.data.limit_move) {
                var a = this.data._img_left, i = this.data._img_top, t = t || this.data.scale, h = this.data.img_width, e = this.data.img_height;
        ...
        _move: function(t) {
            if (!this.data._flag_img_endtouch && this.data.MOVE_THROTTLE_FLAG) {
                if (this.data.MOVE_THROTTLE_FLAG = !1, this._move_throttle(), this._moveDuring(), 
                1 == t.touches.length) {
                    ...
                    if (!this.data.disable_rotate) {
                        var c = 180 / Math.PI * Math.atan2(n[0].y, n[0].x) - 180 / Math.PI * Math.atan2(this.data._touch_img_relative[0].y, this.data._touch_img_relative[0].x), o = 180 / Math.PI * Math.atan2(n[1].y, n[1].x) - 180 / Math.PI * Math.atan2(this.data._touch_img_relative[1].y, this.data._touch_img_relative[1].x);
                        0 != c ? _ = c : 0 != o && (_ = o);
                    }
        ...
        _click: function(t) {
            ...
            this.data.imgSrc ? this._draw(function() {
                var i = t.detail ? t.detail.x : t.touches[0].clientX, h = t.detail ? t.detail.y : t.touches[0].clientY;
        ...
        _draw: function(t) {
            ...
            if (this.data.imgSrc) {
                var i = function() {
                    ...
                    a.data.ctx.drawImage(a.data.imgSrc, -i / 2, -h / 2, i, h), a.data.ctx.draw(!1, function() {
                        t && t();
                    });
                };
        ...
        _cutTouchStart: function(t) {
            var a = t.touches[0].clientX, i = t.touches[0].clientY, h = this.data.cut_top + this.data.height - 30, e = this.data.cut_top + this.data.height + 20, s = this.data.cut_left + this.data.width - 30, d = this.data.cut_left + this.data.width + 30, _ = this.data.cut_top - 30, n = this.data.cut_top + 30, c = this.data.cut_left + this.data.width - 30, o = this.data.cut_left + this.data.width + 30, u = this.data.cut_top - 30, l = this.data.cut_top + 30, g = this.data.cut_left - 30, m = this.data.cut_left + 30, r = this.data.cut_top + this.data.height - 30, f = this.data.cut_top + this.data.height + 30, w = this.data.cut_left - 30, T = this.data.cut_left + 30;
            a > s && a < d && i > h && i < e ? (this._moveDuring(), this.data._flag_cut_touch = !0, 
            this.data._flag_img_endtouch = !0, this.data.CUT_START = {
                width: this.data.width,
                height: this.data.height,
                x: a,
                y: i,
                corner: 4
            }) : a > c && a < o && i > _ && i < n ? (this._moveDuring(), this.data._flag_cut_touch = !0, 
            this.data._flag_img_endtouch = !0, this.data.CUT_START = {
                width: this.data.width,
                height: this.data.height,
                x: a,
                ...
                corner: 3
            }) : a > g && a < m && i > u && i < l ? (this._moveDuring(), this.data._flag_cut_touch = !0, 
            this.data._flag_img_endtouch = !0, this.data.CUT_START = {
                width: this.data.width,
                height: this.data.height,
                cut_top: this.data.cut_top,
                ...
                y: i,
                corner: 2
            }) : a > w && a < T && i > r && i < f && (this._moveDuring(), this.data._flag_cut_touch = !0, 
            this.data._flag_img_endtouch = !0, this.data.CUT_START = {
                width: this.data.width,
                height: this.data.height,
                cut_top: this.data.cut_top,
